...
Active navigation: Health.

## Hero
Breadcrumb: Home → Health
Headline: How can we help you feel better today?
Supporting text: Describe your symptoms and get possible causes, advice, and next steps.
Search placeholder: Describe your health problem...
Chips: Fever | Headache | Stomach pain | Knee pain | Cough

## Unified information card
- Trusted Information — Based on medical knowledge and expert sources.
- Private & Secure — Your information is safe and confidential.
- Helpful Guidance — Clear advice and next steps to help you feel better.
Illustration: medical/stethoscope asset on right, contained within card.

## Notice
Important: This tool provides general information and is not a substitute for professional medical advice, diagnosis, or treatment. If you have a medical emergency, call your local emergency number.

## Popular Symptoms
Fever — High temperature, chills, sweating
Headache — Migraine, tension, sinus pressure
Stomach Pain — Cramps, nausea, indigestion
Knee Pain — Joint pain, swelling, stiffness
Cough — Dry cough, mucus, chest congestion

Bottom reassurance: Your health information is private and anonymous. We're here to help you take the first step toward feeling better.
