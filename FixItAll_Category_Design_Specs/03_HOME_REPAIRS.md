...
# Home Repairs Category

IMPORTANT: Clone the approved Health page layout. Do not create a different hero composition.

Active navigation: Home Repairs.

## Hero
Breadcrumb: Home → Home Repairs
Headline: What needs fixing at home?
Supporting text: Describe the issue and get possible causes, simple checks, and practical next steps.
Search placeholder: Describe your home problem...
Chips: Leaking Tap | AC Not Cooling | Washing Machine | Clogged Drain | Power Issue

## Unified information card
- Practical Solutions — Understand common household problems.
- Simple Checks — Try safe troubleshooting before calling for help.
- Clear Guidance — Know when professional repair is needed.
Illustration: clean house/home-repair asset on right.

## Notice
For electrical hazards, gas leaks, structural damage, flooding, or other dangerous situations, contact a qualified professional immediately.

## Popular Home Problems
Leaking Tap — Dripping, loose fittings, water leaks
AC Not Cooling — Weak airflow, warm air, cooling issues
Washing Machine — Not spinning, draining, or starting
Clogged Drain — Slow drainage and blockages
Power Issue — Tripping circuits and outlet problems

Bottom reassurance: Get practical guidance for everyday household problems and understand when it is time to call a professional.
